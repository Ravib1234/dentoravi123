    ...
    async function handleUpdateJumpstart() {
     ...
     async function handleUpdateLicenses(){
      ...
      async function handleUpdateMarketing() {
        ...
        const totalFieldMarketing = 4;
        let emptyFieldMarketing = 0;
        let completedFieldMarketing = 0;
        

        if(formData.targetMarket == ""){
            emptyFieldMarketing++;
        }
        if( formData.socialMediaMarketing == ""){
          emptyFieldMarketing++;
        }
        if( formData.oldfashionedMarketing== ""){
          emptyFieldMarketing++;
        }
        if( formData.businessReviewsURL   == ""){
          emptyFieldMarketing++;
        }
        
        completedFieldMarketing = totalFieldMarketing - emptyFieldMarketing;
        console.log("Completed Fields", completedFieldMarketing);
      ...
      await API.graphql({
        ...
        variables: {
          input: {
            ...
            emptyFieldMarketing: emptyFieldMarketing,
            completedFieldMarketing: completedFieldMarketing,
        ...
        <> 
             ...
             <Container>
                ...
                <Form onSubmit={submitHandler}>
                 ...
                 <Collapsible trigger="Marketing Data" open>
                 <div className="marketing">
                    <Row>
                        <Col sm={6}>
