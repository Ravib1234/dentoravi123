...
const Support24Hrs = () => {
    return (
      ...
      <div class="container-body top-space-for-nav">
          ...
          <Container>
              <h2 className='GetinTouch'>24 Hours Support</h2>
              <div className='GetinTouch-btm-line'></div>
              <Row>
              <Col align="center" sm={6} >
                    <p className='support-content mt-3' align="left">
                        Need Support? Not to worry, we are here to help you with your needs and allow you to move forward with your business endeavors. Please provide brief details below so we can understand your support need and have an appropriate support personnel contact you within 1 hour ! 
                   </p>
